...
PATH=$PATH:/relax/vc/Common7/IDE:/relax/VC/VC/Bin/amd64:/relax/VC/Common7/Tools:/relax/VC/VC/vcPackages

#### then .Net framework which we need to have clean manifests and SxS for Win7 x64
PATH=$PATH:/cygdrive/c/WINDOWS/Microsoft.NET/Framework:/cygdrive/c/WINDOWS/Microsoft.NET/Framework64:/cygdrive/c/Microsoft.NET/Framework/v2.0.50727

# then SDKs
###PATH=$PATH:/cygdrive/c/PROGRA~1/MICROS~1/Windows/v7.0/bin
###PATH=$PATH:/cygdrive/c/PROGRA~1/MICROS~1/Windows/v6.0A/bin
PATH=$PATH:/relax/SDK/bin/NETFX\ 4.0\ Tools/x64:/relax/SDK/bin/x64:/relax/SDK/bin
...
which mc; which cl;  which link; which mt
echo
